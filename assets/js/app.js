...
const dict = {
  en: {
    ...
    hero: { hello: 'Hello, I’m', lead: 'Founder of Al-Haq Studio & Al-Haq Initiative. Building privacy-first Android apps, focused web platforms, browser extensions, and compiler tools.', ctaProjects: 'View Projects', ctaContact: 'Contact Me', ctaFiverr: 'Hire me on Fiverr', ctaEmail: 'Email me', meta1: 'Android • Web • Desktop • Extensions', meta2: 'AI-assisted' },
    ...
    exp5: { title: 'Alhaq Initiative · Web Platform', date: '2025 — 2026', b1: 'Designed and developed the PWA-ready web home of the Al-Haq Initiative.', b2: 'Built a local-first Quran reader, digital library, responsive infographics, and a secure donation flow.', b3: 'Set up E2E testing pipelines with Cypress and Firebase Hosting deployment workflows.' },
    ...
    proj7: { desc: 'Full-featured organizational website with Quran reader, Islamic library, infographics gallery, donation system, and Al-Haq Hub app landing page. Firebase-hosted PWA with E2E testing.' },
  ...
  fa: {
    ...
    exp3: { title: 'توسعه افزونه VS Code · متن‌باز', date: '۲۰Wait', b1: 'توسعه افزونه VS Code با برجسته‌سازی نحو، IntelliSense و ۴۰+ قطعه کد برای PohLang.', b2: 'یکپارچه‌سازی رانتایم داخلی برای اجرای یک کلیکی بدون وابستگی خارجی.', b3: 'انتشار در بازار VS Code با تسک‌های خودکار و پیکربندی‌های دیباگ.' },
    ...
    btn: { demo: 'دمو', docs: 'مستندات', code: 'کد', install: 'نصب', repo: 'مخزن', readme: 'README', download: 'دانلود', visit: 'بازدید', play: 'گوگل پلی' }, به جامعه خدمت کنند، از تمرکز کاربران محافظت نمایند و با سلامت معنوی همسو باشند.' },
    exp1: { title: 'توسعه زبان PohLang · متن‌باز', date: '۲۰۲۴ — ۲۰۲۵', b1: 'طراحی و پیاده‌سازی یک زبان برنامه‌نویسی عبارتی برای مبتدیان با رانتایم Rust.', b2: 'ساخت زنجیره ابزار کامل کامپایلر: تحلیل‌گر واژگانی، تحلیل‌گر نحوی، کامپایلر بایت‌کد و ماشین مجازی با ۵۰+ تست موفق.', b3: 'دستیابی به وضعیت آماده تولید فاز ۱ با عملگرهای نمادین و پشتیبانی فایل اجرایی بومی.' },
    exp2: { title: 'محیط توسعه PLHub · متن‌باز', date: '۲۰۲۴ — ۲۰۲۵', b1: 'ساخت ابزار CLI حرفه‌ای با دستورات مستقل از زبان، اتوماسیون ساخت و بارگذاری مجدد فوری.', b2: 'پیاده‌سازی ابزارهای استقرار چندسکویی برای Android APK، iOS IPA، Windows EXE و پلتفرم‌های وب.', b3: 'ایجاد یکپارچگی CI/CD با GitHub Actions و کشف خودکار تست برای Python 3.9-3.12.' },
