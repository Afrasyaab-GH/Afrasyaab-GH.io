...
const dict = {
  en: {
    ...
    proj2: { desc: 'Official development environment for PohLang with language-independent commands, build automation, test automation, hot reload, and professional project templates. Like Flutter is    proj3: { desc: 'Full IDE experience with syntax highlighting, IntelliSense, 40+ code snippets, bundled runtime, and one-click execution. No separate download needed, everything in one place.' },
